...
CAPTCHA_ENTIRE_IMAGE_FILE_PATH = 'captcha_entire_image_{}.png'
CAPTCHA_SINGLE_IMAGE_FILE_PATH = 'captcha_single_image_{}.png'
CAPTCHA_RESIZED_IMAGE_FILE_PATH = 'captcha_resized_image_{}.png'

currentRootPath = os.getcwd() #当前运行目录
